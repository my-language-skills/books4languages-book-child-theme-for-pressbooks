...
/**
* ADDED: Display publisher city metadata
*
* SINCE v1.2.4
*/
							...
							$city = $linebreak . " <dt class='block__subtitle block-meta__subtitle'> PUBLISHER CITY </dt> " . $book_information['pb_publisher_city'];
							$Cityy = $linebreak . $city;
							}
							$book_information[$key] = $book_information['pb_publisher'] . $Cityy;
/** End of added code */

							} elseif ( 'pb_publication_date' === $key ) {
								$book_information[ $key ] = " <dt class='block__subtitle block-meta__subtitle'> CITY </dt> " . $book_information['pb_publisher_city'];
